                ...
                <div class="col-md-12">
                    <table id="table_name" >
                        <tr>
                            ...
                            <td colspan="2" style="width: 100%; background: #ddd; border: 1px solid #000; border-left: 1px solid #000;"><h2 class="text-center">टोडाभीम <br>विधान सभा छेत्र (संख्या-81)</h2></td>
                        ...
                        <tr style="border-right: 1px solid #000; border-left: 1px solid #000;">
                            <td colspan="2" style="width: 100%; background: #ddd;"><p class="mt-1 mx-3"><b>बूथ-{{ $chunk_member[0]['booth_id'] }} {{ App\Models\Booth::where('id', $chunk_member[0]['booth_id'])->value('name') }}</b> &nbsp; <span class="hidden-print">({{ count(App\Models\Member::where('booth_id', $chunk_member[0]['booth_id'])->get()) }} Members)</span></p></td>
                            <td style="width: 100px; background: #ddd;"></td>
                            <td style="width: 100px; background: #ddd;"></td>
                        </tr>
                        @endonce
                        <tr style="margin: 0px;">
                            ...
                            <tr style="border-right: 1px solid #000; border-left: 1px solid #000; border-top: 1px solid #000; width: 100%; margin-right: 1px;">
                                <td colspan="2" style="width: 100%; background: #ddd;"><p class="mt-1 mx-3"><b>बूथ-{{ $member->booth_id }} {{ App\Models\Booth::where('id', $member->booth_id )->value('name') }}</b> &nbsp;  <span class="hidden-print">({{ count(App\Models\Member::where('booth_id', $member->booth_id )->get()) }} Members)</span></p></td>
